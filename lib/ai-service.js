  ...
  const response = await fetch('https://api.openai.com/v1/chat/completions', {
    ...
    body: JSON.stringify({
      ...
      messages: [
        {
          role: 'system',
          content: 'You are an expert culinary assistant specializing in diverse, creative, and delicious meal suggestions. You have extensive knowledge of global cuisines, particularly Nigerian and African cooking traditions, cooking techniques, and dietary requirements. You understand cultural dietary preferences like Halal, traditional Nigerian, and modern Nigerian cooking. Always provide unique, varied suggestions that are practical and flavorful. Respond with ONLY valid JSON in the exact format specified.'
        },
        {
          role: 'user',
          content: prompt
      ...
      const response = await fetch('https://api.openai.com/v1/chat/completions', {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
                        role: 'system',
          content: 'You are an expert culinary assistant specializing in global cuisines, with deep knowledge of Nigerian and African cooking traditions. Generate unique, diverse meal suggestions that respect cultural dietary preferences (Halal, traditional Nigerian, etc.). Avoid repeating meal names. Be creative with fusion cuisines, seasonal ingredients, and cooking techniques. Respond with ONLY valid JSON.'
            },
            {
              role: 'user',
